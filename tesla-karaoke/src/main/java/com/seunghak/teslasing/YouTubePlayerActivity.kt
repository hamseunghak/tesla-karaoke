...
class YouTubePlayerActivity : Activity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val channel = intent.getStringExtra(EXTRA_VIDEO_CHANNEL).orEmpty()
        val root = LinearLayout(this).apply {
            orientation = LinearLayout.VERTICAL
            setBackgroundColor(Color.BLACK)
        }
        root.addView(createHeader(title, channel, videoId))
    ...
    private fun createHeader(title: String, channel: String, videoId: String): View {
        ...
        header.addView(Button(this).apply {
            text = "YouTube 앱"
            setOnClickListener { openYouTubeApp(videoId) }
        })
        header.addView(Button(this).apply {
            text = "닫기 ✕"
